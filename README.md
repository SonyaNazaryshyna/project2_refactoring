...
![CI — Whispr](https://github.com/SonyaNazaryshyna/project2_refactoring/actions/workflows/ci.yml/badge.svg)](https://github.com/SonyaNazaryshyna/project2_refactoring/actions/workflows/ci.yml)
